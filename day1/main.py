#Copy the below code and paste it into the function in gfg to be 1 step closer to the prize.
...
def circularSubarraySum(arr):
    ...
    max_subarray_sum = devdotcom(arr, True)

    # Minimum subarray sum (to find the worst-case wrap-around sum)
    min_subarray_sum = devdotcom(arr, False)
